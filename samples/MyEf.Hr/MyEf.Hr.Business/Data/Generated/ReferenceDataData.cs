...
public partial class ReferenceDataData : IReferenceDataData
{
    ...
    public Task<Result<RefDataNamespace.GenderCollection>> GenderGetAllAsync()
        => DataInvoker.Current.InvokeAsync(this, ct => _ef.Query<RefDataNamespace.Gender, EfModel.Gender>().SelectQueryWithResultAsync<RefDataNamespace.GenderCollection>(ct), InvokerArgs.TransactionSuppress);

    /// <inheritdoc/>
    public Task<Result<RefDataNamespace.TerminationReasonCollection>> TerminationReasonGetAllAsync()
        => DataInvoker.Current.InvokeAsync(this, ct => _ef.Query<RefDataNamespace.TerminationReason, EfModel.TerminationReason>().SelectQueryWithResultAsync<RefDataNamespace.TerminationReasonCollection>(ct), InvokerArgs.TransactionSuppress);

    /// <inheritdoc/>
    public Task<Result<RefDataNamespace.RelationshipTypeCollection>> RelationshipTypeGetAllAsync()
        => DataInvoker.Current.InvokeAsync(this, ct => _ef.Query<RefDataNamespace.RelationshipType, EfModel.RelationshipType>().SelectQueryWithResultAsync<RefDataNamespace.RelationshipTypeCollection>(ct), InvokerArgs.TransactionSuppress);

    /// <inheritdoc/>
    public Task<Result<RefDataNamespace.USStateCollection>> USStateGetAllAsync()
        => DataInvoker.Current.InvokeAsync(this, ct => _ef.Query<RefDataNamespace.USState, EfModel.USState>().SelectQueryWithResultAsync<RefDataNamespace.USStateCollection>(ct), InvokerArgs.TransactionSuppress);

    /// <inheritdoc/>
    public Task<Result<RefDataNamespace.PerformanceOutcomeCollection>> PerformanceOutcomeGetAllAsync()
        => DataInvoker.Current.InvokeAsync(this, ct => _ef.Query<RefDataNamespace.PerformanceOutcome, EfModel.PerformanceOutcome>().SelectQueryWithResultAsync<RefDataNamespace.PerformanceOutcomeCollection>(ct), InvokerArgs.TransactionSuppress);
