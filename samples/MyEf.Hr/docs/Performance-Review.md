...
- { name: PerformanceReview, collection: true, collectionResult: true, validator: PerformanceReviewValidator, webApiRoutePrefix: '', entityFrameworkModel: EfModel.PerformanceReview,
    properties: [
