...
namespace My.Hr.Database
{
    ...
    public static class Program
    {
        ...
        static Task<int> Main(string[] args) => DatabaseConsole.Create("Data Source=.;Initial Catalog=My.Hr;Integrated Security=True", "My", "Hr", useBeefDbo: true).RunAsync(args);
    }
}