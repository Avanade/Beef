...
{
    /// <summary>
    /// Gets or sets the 'TerminationReasonId' column value.
    /// </summary>
    ...
    {
        modelBuilder.ThrowIfNull().Entity<TerminationReason>(entity =>
        {
            entity.ToTable("TerminationReason", "Hr");
            entity.HasKey(nameof(TerminationReasonId));
            entity.Property(p => p.TerminationReasonId).HasColumnName("TerminationReasonId").HasColumnType("UNIQUEIDENTIFIER");
    ...
    /// </summary>
    static partial void AddToModel(EntityTypeBuilder<TerminationReason> entity);
}
