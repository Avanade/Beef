...
{
    /// <summary>
    /// Enables the CDC data access for database object 'Legacy.Person'.
    /// </summary>
    public partial interface IPersonCdcData : ICdcDataOrchestrator { }

    /// <summary>
    /// Provides the CDC data access for database object 'Legacy.Person'.
    /// </summary>
    public partial class PersonCdcData : CdcDataOrchestrator<PersonCdc, PersonCdcData.PersonCdcWrapperCollection, PersonCdcData.PersonCdcWrapper, CdcTrackingDbMapper>, IPersonCdcData
    {
        ...
        private static readonly DatabaseMapper<PersonCdc.PersonAddressCdc> _personAddressCdcMapper = DatabaseMapper.CreateAuto<PersonCdc.PersonAddressCdc>();
        ...
        public PersonCdcData(IDatabase db, IEventPublisher evtPub, ILogger<PersonCdcData> logger, IStringIdentifierGenerator idGen) :
            base(db, "[XCdc].[spExecutePersonCdcOutbox]", "[XCdc].[spCompletePersonCdcOutbox]", evtPub, logger, "[XCdc].[spCreateCdcIdentifierMapping]", idGen, new CdcIdentifierMappingDbMapper()) => PersonCdcDataCtor();
        ...
        /// </summary>
        protected override string EventSubject => "Xyz.Legacy.Person";
        ...
        /// </summary>
        protected override Uri? EventSource => new Uri("/legacy_db/person", UriKind.Relative);
