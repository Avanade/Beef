    ...
    public class PersonValidator : Validator<Person>
    {
        ...
        public PersonValidator()
        {
            ...
            Property(x => x.Metadata).Dictionary(item: DictionaryRuleItem.Create(
                key: Validator.CreateFor<string>(r => r.Text("Gender").Mandatory().RefDataCode().As<Gender>()),
                value: Validator.CreateFor<string?>(r => r.Text("Description").Mandatory().String(10))));
        }
    }
}
