    ...
    public partial class TripPersonDataSvc : ITripPersonDataSvc
    {
        ...
        public Task<TripPerson> CreateAsync(TripPerson value)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.PublishValue(__result, $"Demo.TripPerson.{_evtPub.FormatKey(__result)}", "Create").SendAsync().ConfigureAwait(false);
        ...
        public Task<TripPerson> UpdateAsync(TripPerson value)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.PublishValue(__result, $"Demo.TripPerson.{_evtPub.FormatKey(__result)}", "Update").SendAsync().ConfigureAwait(false);
                _cache.SetValue((__result as IUniqueKey).UniqueKey, __result);
                return __result;
            });
        }
        ...
        public Task DeleteAsync(string? id)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.Publish($"Demo.TripPerson.{_evtPub.FormatKey(id)}", "Delete", id).SendAsync().ConfigureAwait(false);
