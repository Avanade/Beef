...
namespace Beef.Demo.Business.DataSvc
{
    ...
    public partial class RobotDataSvc : IRobotDataSvc
    {
        ...
        public RobotDataSvc(IRobotData data, IEventPublisher evtPub, IRequestCache cache) { _data = Check.NotNull(data, nameof(data)); _evtPub = Check.NotNull(evtPub, nameof(evtPub)); _cache = Check.NotNull(cache, nameof(cache)); RobotDataSvcCtor(); }
        ...
        public Task<Robot> CreateAsync(Robot value)
        {
            return DataSvcInvoker.Default.InvokeAsync(typeof(RobotDataSvc), async () => 
            {
                ...
                await _evtPub.PublishValueEventAsync(__result, $"Demo.Robot.{__result.Id}", "Create").ConfigureAwait(false);
        ...
        public Task<Robot> UpdateAsync(Robot value)
        {
            return DataSvcInvoker.Default.InvokeAsync(typeof(RobotDataSvc), async () => 
            {
                ...
                await _evtPub.PublishValueEventAsync(__result, $"Demo.Robot.{__result.Id}", "Update").ConfigureAwait(false);
                _cache.SetValue(__result.UniqueKey, __result);
                return __result;
            });
        }
        ...
        public Task DeleteAsync(Guid id)
        {
            return DataSvcInvoker.Default.InvokeAsync(typeof(RobotDataSvc), async () => 
            {
                ...
                await _evtPub.PublishEventAsync($"Demo.Robot.{id}", "Delete", id).ConfigureAwait(false);
