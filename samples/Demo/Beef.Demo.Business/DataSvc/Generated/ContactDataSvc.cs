    ...
    public partial class ContactDataSvc : IContactDataSvc
    {
        ...
        public Task<Contact> CreateAsync(Contact value)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.PublishValue(__result, $"Demo.Contact.{_evtPub.FormatKey(__result)}", "Create").SendAsync().ConfigureAwait(false);
        ...
        public Task<Contact> UpdateAsync(Contact value)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.PublishValue(__result, $"Demo.Contact.{_evtPub.FormatKey(__result)}", "Update").SendAsync().ConfigureAwait(false);
                _cache.SetValue((__result as IUniqueKey).UniqueKey, __result);
                return __result;
            });
        }
        ...
        public Task DeleteAsync(Guid id)
        {
            return DataSvcInvoker.Current.InvokeAsync(this, async () =>
            {
                ...
                await _evtPub.Publish($"Demo.Contact.{_evtPub.FormatKey(id)}", "Delete", id).SendAsync().ConfigureAwait(false);
