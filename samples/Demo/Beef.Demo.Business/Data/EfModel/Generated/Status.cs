...
public partial class Status
{
    ...
    {
        modelBuilder.ThrowIfNull().Entity<Status>(entity =>
        {
            entity.ToTable("Status", "Ref");
            entity.HasKey(nameof(StatusId));
            entity.Property(p => p.StatusId).HasColumnName("StatusId").HasColumnType("NVARCHAR(50)");
