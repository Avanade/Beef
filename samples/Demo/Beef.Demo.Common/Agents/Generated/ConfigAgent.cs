...
{
    /// <summary>
    /// Defines the Config Web API agent.
    /// </summary>
    ...
    /// <summary>
    /// Provides the Config Web API agent.
    /// </summary>
    public partial class ConfigAgent : WebApiAgentBase, IConfigAgent
    {
        ...
        {
            return PostAsync<System.Collections.IDictionary>("api/v1/envvars", requestOptions: requestOptions,
