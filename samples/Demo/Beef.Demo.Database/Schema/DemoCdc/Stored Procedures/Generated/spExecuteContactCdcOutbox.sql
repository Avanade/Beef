...
BEGIN
  ...
  BEGIN TRY
    ...
    IF (@ContactMinLsn < @ContactBaseMinLsn) BEGIN IF (@ContinueWithDataLoss = 1) BEGIN SET @ContactMinLsn = @ContactBaseMinLsn END ELSE BEGIN COMMIT TRANSACTION RETURN -2 END END
    IF (@AddressMinLsn < @AddressBaseMinLsn) BEGIN IF (@ContinueWithDataLoss = 1) BEGIN SET @AddressMinLsn = @AddressBaseMinLsn END ELSE BEGIN COMMIT TRANSACTION RETURN -2 END END
