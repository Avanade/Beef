...
BEGIN
  ...
  BEGIN TRY
    ...
    IF (@PersonMinLsn < @PersonBaseMinLsn) BEGIN IF (@ContinueWithDataLoss = 1) BEGIN SET @PersonMinLsn = @PersonBaseMinLsn END ELSE BEGIN COMMIT TRANSACTION RETURN -2 END END
