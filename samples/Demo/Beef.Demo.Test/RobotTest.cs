...
namespace Beef.Demo.Test
{
    ...
    public class RobotTest
    {
        ...
        {
            var config = AgentTester.BuildConfiguration<Startup>("Beef").GetSection("CosmosDb");
        ...
        {
            if (_agentTester != null)
                _agentTester.Dispose();
        ...
        public void E110_Create()
        {
            ...
            // Create a robot.
            r = _agentTester.Test<RobotAgent, Robot>()
        ...
        public void F140_Update()
        {
            ...
            v = _agentTester.Test<RobotAgent, Robot>()
                .ExpectStatusCode(HttpStatusCode.OK)
