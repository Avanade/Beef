...
namespace Beef.Demo.Api.Controllers
{
    ...
    public partial class PersonController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(PersonCollection), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.NoContent)]
        public IActionResult GetByArgs(string firstName = default(string), string lastName = default(string), List<string> genders = default(List<string>))
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.NoContent)]
        public IActionResult GetDetailByArgs(string firstName = default(string), string lastName = default(string), List<string> genders = default(List<string>))
        {
            var args = new PersonArgs { FirstName = firstName, LastName = lastName, GendersSids = genders };
        ...
        [ProducesResponseType(typeof(PersonCollection), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.NoContent)]
        public IActionResult GetByArgsWithEf(string firstName = default(string), string lastName = default(string), List<string> genders = default(List<string>))
        {
            var args = new PersonArgs { FirstName = firstName, LastName = lastName, GendersSids = genders };
