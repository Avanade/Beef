...
Perform a solution-wide NuGet Package upgrade to the latest 4.0.1 (or greater). Take this opportunity to upgrade all other packages to their respective latest also. 
