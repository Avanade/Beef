...
**`cdc`** | The corresponding [`Cdc`](Database-Cdc-Config.md) collection.<br/><br/>A `Cdc` object provides the primary configuration for Change Data Capture (CDC), including multiple table joins to form a composite entity.
