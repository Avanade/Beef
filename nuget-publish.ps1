<#
    ...
    .Example
    C:\PS> .\nuget-publish.ps1 -NugetServer 'https://api.nuget.org/v3/index.json' -ApiKey 'key' -IncludeSymbols -IncludeSource -ProjectsToPublish @('Beef.CodeGen.Core', 'Beef.Database.Core')
