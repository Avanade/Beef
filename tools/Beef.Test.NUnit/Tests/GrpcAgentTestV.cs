...
namespace Beef.Test.NUnit.Tests
{
    ...
    public class GrpcAgentTest<TStartup, TAgent, TValue> : GrpcAgentTestBase<TStartup> where TStartup : class where TAgent : GrpcAgentBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> class with a username.
        /// </summary>
        ...
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectStatusCode(HttpStatusCode statusCode)
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectErrorType(ErrorType errorType, string? errorMessage = null)
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectMessages(params string[] messages)
        {
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectNullValue()
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectValue(Func<GrpcAgentTest<TStartup, TAgent, TValue>, TValue> valueFunc, params string[] membersToIgnore)
        {
        ...
        /// <param name="membersToIgnore">The members to ignore from the comparison.</param>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectValue(TValue value, params string[] membersToIgnore) => ExpectValue(_ => value, membersToIgnore);
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> IgnoreChangeLog()
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectChangeLogCreated(string? createdby = null, DateTime? createdDateGreaterThan = null)
        {
            Check.IsTrue(typeof(TValue).GetInterface(typeof(IChangeLog).Name) != null, "TValue must implement the interface IChangeLog.");
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectChangeLogUpdated(string? updatedby = null, DateTime? updatedDateGreaterThan = null)
        {
            Check.IsTrue(typeof(TValue).GetInterface(typeof(IChangeLog).Name) != null, "TValue must implement the interface IChangeLog.");
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> IgnoreETag()
        {
        ...
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectETag(string? previousETag = null)
        {
            Check.IsTrue(typeof(TValue).GetInterface(typeof(IETag).Name) != null, "TValue must implement the interface IETag.");
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectUniqueKey()
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectEvent(string template, string action)
        {
        ...
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectEvent<T>(string template, string action, T eventValue, params string[] membersToIgnore)
        {
        ...
        /// <param name="action">The optional expected action; <c>null</c> indicates any.</param>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectEventWithValue(string template, string action)
        {
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> ExpectNoEvents()
        {
            SetExpectNoEvents();
            return this;
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GrpcAgentTest{TStartup, TAgent, TValue}"/> instance to support fluent/chaining usage.</returns>
        public GrpcAgentTest<TStartup, TAgent, TValue> IgnorePublishSendEventMismatch()
        {
        ...
        public GrpcAgentResult<TValue> Run(Func<TAgent, Task<GrpcAgentResult<TValue>>> func)
        {
        ...
        public async Task<GrpcAgentResult<TValue>> RunAsync(Func<TAgent, Task<GrpcAgentResult<TValue>>> func)
        {
            if (func == null)
        ...
        public GrpcAgentResult<TValue> RunOverride(Func<Task<GrpcAgentResult<TValue>>> func) => Task.Run(() => RunOverrideAsync(func)).Result;
        ...
        /// <param name="func">The function to execute.</param>
        /// <returns>The corresponding <see cref="Task{TResult}"/>.</returns>
        public async Task<GrpcAgentResult<TValue>> RunOverrideAsync(Func<Task<GrpcAgentResult<TValue>>> func)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
            ...
            GrpcAgentResult<TValue> result = await func().ConfigureAwait(false);
            sw.Stop();
            ...
            if ((_isExpectCreatedBy || _isExpectUpdatedBy || _isExpectedETag || _isExpectedUniqueKey || _expectValueFunc != null) && !result.HasValue)
                Assert.Fail($"Expected non-null response value; no response returned.");
