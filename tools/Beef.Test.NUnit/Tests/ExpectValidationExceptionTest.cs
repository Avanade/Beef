...
{
    /// <summary>
    /// Performs the <see cref="ExpectValidationException"/> logic.
    /// </summary>
    ...
    public class ExpectValidationExceptionTest
    {
        /// <summary>
        ...
        [System.Diagnostics.DebuggerStepThrough]
        public void Throws(Action action, params string[] messages)
        {
        ...
        [System.Diagnostics.DebuggerStepThrough]
        public void Throws(Action action, MessageItemCollection messages)
        {
        ...
        [System.Diagnostics.DebuggerStepThrough]
        public void Throws(Func<Task> func, params string[] messages)
        {
            var mic = new MessageItemCollection();
            foreach (var text in messages)
            {
        ...
        /// <remarks>Will only check the <see cref="MessageItem.Property"/> where specified (not <c>null</c>).</remarks>
        [System.Diagnostics.DebuggerStepThrough]
        public void Throws(Func<Task> func, MessageItemCollection messages)
        {
            if (func == null)
        ...
        /// <returns>The corresponding <see cref="Task"/>.</returns>
        [System.Diagnostics.DebuggerStepThrough]
        public Task ThrowsAsync(Func<Task> func, params string[] messages)
        {
            if (func == null)
                throw new ArgumentNullException(nameof(func));
        ...
        [System.Diagnostics.DebuggerStepThrough]
        public void CompareExpectedVsActual(MessageItemCollection expectedMessages, ValidationException vex)
        {
            if (vex == null)
