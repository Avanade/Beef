...
namespace Beef.CodeGen.Config.Database
{
    ...
    {
        private static readonly string[] _intTypes = new string[] { "int", "short", "long", "unit", "ushort", "ulong", "byte" };
        ...
        /// Gets the corresponding .NET <see cref="System.Type"/> name.
        /// </summary>
        public string DotNetType => new DbEx.SqlServer.SqlServerSchemaConfig(Root!.Migrator!).ToDotNetTypeName(DbColumn!);
