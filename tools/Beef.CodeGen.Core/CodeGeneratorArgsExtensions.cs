...
namespace Beef.CodeGen
{
    ...
    public static class CodeGeneratorArgsExtensions
    {
        ...
        public static string GetCompany(this ICodeGeneratorArgs args, bool throwWhereNotFound = false) => (args ?? throw new ArgumentNullException(nameof(args))).GetParameter(CodeGenConsole.CompanyParamName, throwWhereNotFound)!;
        ...
        /// <param name="args">The <see cref="ICodeGeneratorArgs"/>.</param>
        /// <param name="throwWhereNotFound">Indicates to throw a <see cref="KeyNotFoundException"/> when the specified key is not found.</param>
        public static string GetAppName(this ICodeGeneratorArgs args, bool throwWhereNotFound = false) => (args ?? throw new ArgumentNullException(nameof(args))).GetParameter(CodeGenConsole.AppNameParamName, throwWhereNotFound)!;
