...
using {{Root.Company}}.{{Root.AppName}}.Business;
using {{Root.Company}}.{{Root.AppName}}.Common.Grpc;
using {{Root.Company}}.{{Root.AppName}}.Common.Grpc.Proto;
...
namespace {{Root.Company}}.{{Root.AppName}}.{{Root.ApiName}}.Grpc
{
    /// <summary>
