...
- *Enhancement*: Added new `CodeGeneration.PragmaWarnings` to list additional pragma warning to apply to the code. As a minimum the `ConfigBase.DefaultPragmaWarnings` will be used. This standardizes across all C# generated code.
