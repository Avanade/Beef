...
namespace Beef.Data.Cosmos
{
    ...
    public interface ICosmosDb
    {
        ...
        CosmosDbContainer<T, TModel> Container<T, TModel>(ICosmosDbArgs dbArgs) where T : class, new() where TModel : class, new();
        ...
        CosmosDbValueContainer<T, TModel> ValueContainer<T, TModel>(ICosmosDbArgs dbArgs) where T : class, new() where TModel : class, new();
        ...
        CosmosDbQuery<T, TModel> Query<T, TModel>(ICosmosDbArgs dbArgs, Func<IQueryable<TModel>, IQueryable<TModel>>? query = null) where T : class, new() where TModel : class, new();
        ...
        CosmosDbValueQuery<T, TModel> ValueQuery<T, TModel>(ICosmosDbArgs dbArgs, Func<IQueryable<CosmosDbValue<TModel>>, IQueryable<CosmosDbValue<TModel>>>? query = null) where T : class, new() where TModel : class, new();
    }
}