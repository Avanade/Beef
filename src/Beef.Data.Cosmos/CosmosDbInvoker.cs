...
{
    /// <summary>
    /// Adds capabilities (wraps) an <see cref="InvokerBase{TParam}"/> enabling standard functionality to be added to all <see cref="CosmosDbBase"/> invocations
    /// specifically exception handling (see <see cref="CosmosDbBase.ExceptionHandler"/>).
    /// </summary>
    public class CosmosDbInvoker : InvokerBase<CosmosDbBase>
    {
        #region NoResult
