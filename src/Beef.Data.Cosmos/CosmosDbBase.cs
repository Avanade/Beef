...
namespace Beef.Data.Cosmos
{
    ...
    public abstract class CosmosDbBase : ICosmosDb
    {
        ...
        public CosmosDbContainer<T, TModel> Container<T, TModel>(ICosmosDbArgs dbArgs) where T : class, new() where TModel : class, new()
        ...
        public CosmosDbValueContainer<T, TModel> ValueContainer<T, TModel>(ICosmosDbArgs dbArgs) where T : class, new() where TModel : class, new()
        ...
        /// to all queries, plus create, update, delete and get operations. Can be overridden for a specific instance using the <see cref="ICosmosDbArgs.SetAuthorizeFilter(Func{IQueryable, IQueryable})"/>.
        /// </summary>
        ...
        /// <typeparam name="TModel">The cosmos model <see cref="Type"/>.</typeparam>
        /// <param name="dbArgs">The <see cref="ICosmosDbArgs"/>.</param>
        internal protected ItemRequestOptions GetItemRequestOptions<T, TModel>(ICosmosDbArgs? dbArgs = null) where T : class, new() where TModel : class, new()
        {
        ...
        /// <typeparam name="TModel">The cosmos model <see cref="Type"/>.</typeparam>
        /// <param name="dbArgs">The <see cref="ICosmosDbArgs"/>.</param>
        internal protected QueryRequestOptions GetQueryRequestOptions<T, TModel>(ICosmosDbArgs dbArgs) where T : class, new() where TModel : class, new()
        {
            if (dbArgs == null)
        ...
        public CosmosDbQuery<T, TModel> Query<T, TModel>(ICosmosDbArgs dbArgs, Func<IQueryable<TModel>, IQueryable<TModel>>? query = null) where T : class, new() where TModel : class, new() =>
        ...
        public CosmosDbValueQuery<T, TModel> ValueQuery<T, TModel>(ICosmosDbArgs dbArgs, Func<IQueryable<CosmosDbValue<TModel>>, IQueryable<CosmosDbValue<TModel>>>? query = null) where T : class, new() where TModel : class, new() =>
