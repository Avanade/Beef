...
namespace Beef.Data.OData
{
    ...
    public interface IOData
    {
        ...
        ODataQuery<T, TModel> Query<T, TModel>(IODataArgs queryArgs, Func<Soc.IBoundClient<TModel>, Soc.IBoundClient<TModel>>? query = null) where T : class, new() where TModel : class, new();
        ...
        Task<T?> GetAsync<T, TModel>(IODataArgs getArgs, params IComparable?[] keys) where T : class, new() where TModel : class, new();
        ...
        Task<T> CreateAsync<T, TModel>(IODataArgs saveArgs, T value) where T : class, new() where TModel : class, new();
        ...
        Task<T> UpdateAsync<T, TModel>(IODataArgs saveArgs, T value) where T : class, new() where TModel : class, new();
        ...
        Task DeleteAsync<T, TModel>(IODataArgs saveArgs, params IComparable?[] keys) where T : class, new() where TModel : class, new();
    }
}