...
namespace Beef.Data.OData
{
    ...
    public interface IODataPropertyMapper : IPropertyMapperBase
    {
        ...
        /// </summary>
        /// <returns><b>true</b> indicates that the mapping should occur; otherwise, <b>false</b>.</returns>
        ...
        where TSrce : class
    {
        ...
        /// </summary>
        /// <param name="autoGeneratedOnCreate">Indicates whether the destination property value is auto-generated on create (defaults to <b>true</b>).</param>
        ...
        /// <summary>
        /// Defines a conditional clause which must be <b>true</b> when mapping from the source to the destination.
        /// </summary>
        ...
        /// <summary>
        /// Defines a conditional clause which must be <b>true</b> when mapping from the destination.
        /// </summary>
        /// <param name="predicate">A function to determine whether the property is to be mapped.</param>
        /// <returns>The <see cref="ODataPropertyMapper{TEntity, TProperty}"/>.</returns>
