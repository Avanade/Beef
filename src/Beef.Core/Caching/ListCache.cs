...
namespace Beef.Caching
{
    ...
    public class ListCache<TItem> : CacheCoreBase
    {
        ...
        /// <summary>
        /// Gets the current count of items in the cache (both expired and non-expired may co-exist until flushed).
        /// </summary>
        public override long Count => _cache == null ? 0 : _cache.Count();
