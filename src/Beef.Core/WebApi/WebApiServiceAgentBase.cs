...
namespace Beef.WebApi
{
    ...
    /// </summary>
    /// <remarks>Each <b>invoke</b> is wrapped by a <see cref="WebApiServiceAgentInvoker"/> to support additional logic where required.</remarks>
...
#pragma warning restore CA1000 
        ...
        protected WebApiServiceAgentBase(HttpClient? client = null, Action<HttpRequestMessage>? beforeRequest = null) : base(client ?? Default?.Client, beforeRequest ?? Default?.BeforeRequest, () => (_create ?? throw new InvalidOperationException("The Register method must register prior to usage.")).Invoke()!) { }
    }
